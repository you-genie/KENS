...
namespace state_machine {
    ...
    extern StateNode *node_closed = new StateNode(Label::CLOSED, "Closed");
    extern StateNode *node_syn_sent = new StateNode(Label::SYN_SENT, "Syn Sent");
    extern StateNode *node_established = new StateNode(Label::ESTABLISHED, "Established");
    extern StateNode *node_fin_wait_1 = new StateNode(Label::FIN_WAIT_1, "Fin Wait 1");
    extern StateNode *node_fin_wait_2 = new StateNode(Label::FIN_WAIT_2, "Fin Wait 2");
    extern StateNode *node_closing = new StateNode(Label::CLOSING, "Closing");
    extern StateNode *node_time_wait = new StateNode(Label::TIME_WAIT, "Time Wait");
    extern StateNode *node_listen = new StateNode(Label::LISTEN, "Listen");
    extern StateNode *node_syn_rcvd = new StateNode(Label::SYN_RCVD, "Syn Received");
    extern StateNode *node_close_wait = new StateNode(Label::CLOSE_WAIT, "Close Wait");
    extern StateNode *node_last_ack = new StateNode(Label::LAST_ACK, "Last Ack");
    extern StateNode *node_none = new StateNode(Label::NONE, "None");

    extern StateNode *state_label_table[12] = {
    ...
    extern StateLink *cli_closed_table[3] = {
    ...
    extern StateLink *cli_syn_sent_table[3] = {
    ...
    extern StateLink *cli_established_table[3] = {
    ...
    extern StateLink *cli_fin_wait_1_table[3] = {
    ...
    extern StateLink *cli_closing_table[3] = {
    ...
    extern StateLink *cli_fin_wait_2_table[3] = {
    ...
    extern StateLink *cli_time_wait_table[3] = {
    ...
    extern StateLink *serv_closed_table[3] = {
    ...
    extern StateLink *serv_listen_table[3] = {
    ...
    extern StateLink *serv_syn_rcvd_table[3] = {
    ...
    extern StateLink *serv_established_table[3] = {
    ...
    extern StateLink *serv_close_wait_table[3] = {

...
namespace E {
    ...
    private:
        ...
        void CreatePacketHeader(
                Packet *packet, TCPHeader *packet_header, uint32_t *src_ip, uint32_t *dest_ip,
         ...
         */
        int FindDataIndexWithSeq(uint32_t seq_num, WriteBuffer *write_buffer);
        /**
    ...
    public:
         ...
         * @return -1 에러라면!!!
         */
        int DeleteDataWithSeq(uint32_t seq_num, WriteBuffer *write_buffer);
        /**
